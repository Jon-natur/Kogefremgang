...
//ol.proj.get("EPSG:25832").setExtent([685031.748212, 6147574.846402, 696537.771341, 6156329.848900]);
var wms_layers = [];
...
var format_fremgangsoversigttilwebkort_3 = new ol.format.GeoJSON();
var features_fremgangsoversigttilwebkort_3 = format_fremgangsoversigttilwebkort_3.readFeatures(json_fremgangsoversigttilwebkort_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:25832'});
var jsonSource_fremgangsoversigttilwebkort_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_fremgangsoversigttilwebkort_3.addFeatures(features_fremgangsoversigttilwebkort_3);
var lyr_fremgangsoversigttilwebkort_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_fremgangsoversigttilwebkort_3, 
                style: style_fremgangsoversigttilwebkort_3,
                popuplayertitle: 'fremgangsoversigt - til webkort',
                interactive: true,
    title: 'fremgangsoversigt - til webkort<br />\
    <img src="styles/legend/fremgangsoversigttilwebkort_3_0.png" /> Sø<br />\
    <img src="styles/legend/fremgangsoversigttilwebkort_3_1.png" /> Mose<br />\
    <img src="styles/legend/fremgangsoversigttilwebkort_3_2.png" /> Eng<br />\
    <img src="styles/legend/fremgangsoversigttilwebkort_3_3.png" /> Overdrev<br />\
    <img src="styles/legend/fremgangsoversigttilwebkort_3_4.png" /> Hede<br />\
    <img src="styles/legend/fremgangsoversigttilwebkort_3_5.png" /> Potentiel ny eng<br />\
    <img src="styles/legend/fremgangsoversigttilwebkort_3_6.png" /> Potentiel ny mose<br />\
    <img src="styles/legend/fremgangsoversigttilwebkort_3_7.png" /> Potentiel ny sø<br />\
    <img src="styles/legend/fremgangsoversigttilwebkort_3_8.png" /> Potentiel ny overdrev<br />' });
var group_2025 = new ol.layer.Group({
                                layers: [lyr_Udpeget_opgraderet_2,lyr_fremgangsoversigttilwebkort_3,],
                                fold: 'open',
                                title: '2025'});

lyr_GoogleSatelithybrid_0.setVisible(true);lyr_2025projektomrde_1.setVisible(true);lyr_Udpeget_opgraderet_2.setVisible(false);lyr_fremgangsoversigttilwebkort_3.setVisible(true);
var layersList = [lyr_GoogleSatelithybrid_0,lyr_2025projektomrde_1,group_2025];
...
lyr_fremgangsoversigttilwebkort_3.set('fieldAliases', {'Temakode': 'Temakode', 'Temanavn': 'Temanavn', 'Objekt_id': 'Objekt id', 'Version_id': 'Version_id', 'Systid_fra': 'Systid_fra', 'Systid_til': 'Systid_til', 'Oprettet': 'Oprettet', 'Oprindkode': 'Oprindkode', 'Oprindelse': 'Oprindelse', 'Statuskode': 'Statuskode', 'Status': 'Status', 'Off_kode': 'Off_kode', 'Offentlig': 'Offentlig', 'CVR_kode': 'CVR_kode', 'CVR_navn': 'CVR_navn', 'Bruger_id': 'Bruger_id', 'Link': 'Link', 'Shape_area': 'Polygon areal', 'Shape_leng': 'Shape_leng', 'Natyp_kode': 'Naturtype kode', 'Natyp_navn': 'Naturtype', 'Besig_dato': 'Besigtigelsesdato', 'layer': 'layer', 'path': 'path', 'Note': 'Note', 'M.O': 'Mulige overtrædelser', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Afstand': 'Afstand', 'Polygon_Na': 'Felt ID', });
...
lyr_fremgangsoversigttilwebkort_3.set('fieldImages', {'Temakode': 'TextEdit', 'Temanavn': 'TextEdit', 'Objekt_id': 'TextEdit', 'Version_id': 'TextEdit', 'Systid_fra': 'TextEdit', 'Systid_til': 'TextEdit', 'Oprettet': 'TextEdit', 'Oprindkode': 'TextEdit', 'Oprindelse': 'TextEdit', 'Statuskode': 'TextEdit', 'Status': 'TextEdit', 'Off_kode': 'TextEdit', 'Offentlig': 'TextEdit', 'CVR_kode': 'TextEdit', 'CVR_navn': 'TextEdit', 'Bruger_id': 'TextEdit', 'Link': 'TextEdit', 'Shape_area': 'TextEdit', 'Shape_leng': 'TextEdit', 'Natyp_kode': 'TextEdit', 'Natyp_navn': 'TextEdit', 'Besig_dato': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', 'Note': 'TextEdit', 'M.O': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Afstand': 'TextEdit', 'Polygon_Na': 'TextEdit', });
